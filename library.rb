class Book
    ...
    def get_all_book
        i=1
        # puts "FROM BOOK CLASS",
        #  @@array_of_book
        puts "1111111111111111111", @@array_of_book.map {|book| book.name}
    ...
    def self.get_all_books
      p "1111111111111111111", @@array_of_book.map {|book| book.name}
      @@array_of_book
    end
    ...
    def borrow_book
          ...
          member_temp = @@array_of_members.at(i)
            ...
            if(var.name == username)
                ...
                puts "\nenter book number y1ou want to buy"
